...
<body>
  <div class="wrapper">
    ...
    <form action="eloginprocess.php" method ="POST">
              <div class="field">
        ...
        <div class="field">
              <input type="submit" value="Login" name="edulogin" id="edulogin">
        </div>
        <div class="signup-link">
        Not a member? <a href="educatorsregister.php">Signup now</a></div>
    </form>
  </div>
</body>
</html>
